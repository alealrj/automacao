...
@TID107886REV0.2.0
Feature: Validar api de relacionamento de pessoa natural - BFinanciamentos Supply

  Scenario: Validar api de relacionamento de pessoa natural - BFinanciamentos Supply
