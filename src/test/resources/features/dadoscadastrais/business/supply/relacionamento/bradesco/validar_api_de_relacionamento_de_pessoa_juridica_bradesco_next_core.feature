...
@TID100017REV0.2.0
Feature: Validar api de relacionamento de pessoa juridica - Bradesco Next Core

	Scenario: Validar api de relacionamento de pessoa juridica - Bradesco Next Core
