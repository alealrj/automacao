package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.supply.identificacao.agora;
...
public class PessoaIdentificacaoAgoraStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<PersonalCustomerIdentificationSupply> identificacaoPessoalAgora;

    private final String ROOT_JSON_SCHEMA_PATH = "src/main/resources/schema/personal/identification/";

    private final String JSON_SUPPLY_AGORA_SCHEMA_NAME = "personal_identification_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/personal/identification/";

    private final String JSON_SUPPLY_AGORA_DATA_NAME = "personal_identification_supply_agora_data";

    private final String URL_PESSOAL_IDENTIFICACAO_AGORA_SUPPLY = "/agora/customers/v1/personal/identifications";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_Identificação_Pessoa_Natural() {
        ...
        identificacaoPessoalAgora = fornecimentoService.getResponseListData(ProjectType.REGISTRATION_DATA_AGORA_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_AGORA_DATA_NAME, getHeaders(headerMap),
                PersonalCustomerIdentificationSupply.class, URL_PESSOAL_IDENTIFICACAO_AGORA_SUPPLY);

        printJsonBradescoReport(identificacaoPessoalAgora);
    ...
    public void usuario_deve_receber_os_status_code(int statusCode) {
        ...
        assertEquals(statusCode, identificacaoPessoalAgora.getHttpCode());
    ...
    public void o_retorno_das_requisicões_deve_estar_de_acordo_com_contrato_definido() {
        ...
        boolean responseValid = fornecimentoService.validateSchema(ROOT_JSON_DATA_PATH, JSON_SUPPLY_AGORA_DATA_NAME,
                ROOT_JSON_SCHEMA_PATH, JSON_SUPPLY_AGORA_SCHEMA_NAME);
