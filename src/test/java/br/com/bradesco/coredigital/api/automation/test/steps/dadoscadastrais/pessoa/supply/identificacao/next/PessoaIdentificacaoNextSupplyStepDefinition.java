package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.supply.identificacao.next;
...
public class PessoaIdentificacaoNextSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private final String JSON_SUPPLY_DATA_NAME = "personal_identification_next_supply_data";

    private final String URL_PESSOAL_IDENTIFICACAO_NEXT_SUPPLY = "/next/customers/v1/personal/identifications";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_Identificação_Pessoa_Natural() {
        ...
        identificacaoPessoal = fornecimentoService.getResponseListData(ProjectType.REGISTRATION_DATA_BRADESCO_OR_NEXT_SUPPLY,
                ...
                URL_PESSOAL_IDENTIFICACAO_NEXT_SUPPLY);
