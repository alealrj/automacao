package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.direitoscreditoriosdescontados.cws.contrato;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.factory.cws.CwsContractDcomFactory;
import br.com.bradesco.coredigital.api.automation.model.request.cws.CwsContractDcomRequest;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseObject;
import br.com.bradesco.coredigital.api.automation.model.response.cws.ResponseContractDcomCwsObject;
...
public class DireitosCreditoriosDescontadosContratoCwsStepDefinition extends AbstractStepDefinition {
    ...
    @Autowired
    private CwsContractDcomFactory cwsContractDcomFactory;

    private ResponseObject<ResponseContractDcomCwsObject> responseContractDcomCwsObject;
    ...
    private final String JSON_CWS_SCHEMA_NAME = "contract_invoice_financings_cws_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/invoicefinancings/";

    private final String JSON_CWS_DATA_NAME = "contract_invoicefinancings_cws_data";

    private final String URL_DCOM_CONTRATO_CWS = "/rest/cws/v1/contract";
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_de_direitos_creditorios_descontados_dcom_contrato() {
        ...
        CwsContractDcomRequest cwsContractDcomRequest = cwsContractDcomFactory.buildCwsDcomRequest(
                requestDate, requestDatePeriodBegin, requestDatePeriodEnd, contractId
        );

        responseContractDcomCwsObject = fornecimentoService.postObject(
                ProjectType.INVOICE_FINANCINGS_CONTRACT_CWS,
                ROOT_JSON_DATA_PATH,
                JSON_CWS_DATA_NAME,
                getHeaders(headerMap),
                cwsContractDcomRequest,
                ResponseContractDcomCwsObject.class,
                URL_DCOM_CONTRATO_CWS
        );

        printJsonBradescoReport(responseContractDcomCwsObject);
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_de_direitos_creditorios_descontados_dcom_contrato_com_header_invalido() {
    ...
    public void pegar_o_status_code_da_requisicao() {
        statusCode = responseContractDcomCwsObject.getHttpCode();
    ...
    public void a_Mensagem_De_Erro_Deve_Ser(String mensagem) {
        String erro = responseContractDcomCwsObject.getErrors().get(0).getDetail();
