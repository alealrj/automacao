package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.business.supply.qualificacao.bfinanciamento;
...
public class BusinessQualificationBfinanciamentoSupplyStepsDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<BusinessQualificationSupply> qualificacaoJuridicaBfinanciamentoSupply;

    private final String ROOT_JSON_SCHEMA_PATH = "src/main/resources/schema/business/qualification/";

    private final String JSON_SUPPLY_SCHEMA_NAME = "business_qualification_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/business/qualification/";

    private final String JSON_SUPPLY_DATA_NAME = "business_qualification_supply_bfinanciamento_data";

    private final String URL_BUSINESS_QUALIFICACAO_BFINANCIAMENTO_SUPPLY = "/bradesco_financiamento/customers/v1/business/qualifications";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_qualificação_Pessoa_Juridica() {
        ...
        qualificacaoJuridicaBfinanciamentoSupply = fornecimentoService.getResponseObject(ProjectType.REGISTRATION_DATA_LOSANGO_OR_BF_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, getHeaders(headerMap),
                BusinessQualificationSupply.class, URL_BUSINESS_QUALIFICACAO_BFINANCIAMENTO_SUPPLY);

        printJsonBradescoReport(qualificacaoJuridicaBfinanciamentoSupply);
    ...
    public void deve_retornar_status_code_para_chamada_de_qualificação_Pessoa_Juridica(int statusCode) {
        ...
        assertEquals(statusCode, qualificacaoJuridicaBfinanciamentoSupply.getHttpCode());
