package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.supply.relacionamento.next;
...
public class PessoaRelacionamentoNextSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private final String JSON_SUPPLY_DATA_NAME = "personal_relation_next_supply_data";

    private final String URL_PESSOAL_RELACIONAMENTO_NEXT_SUPPLY = "/next/customers/v1/personal/financial-relations";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_Relacionamento_Pessoa_Natural() {
        ...
        relacionamentoPessoal = fornecimentoService.getResponseObject(ProjectType.REGISTRATION_DATA_BRADESCO_OR_NEXT_SUPPLY,
                ...
                PersonalCustomerRelationSupply.class, URL_PESSOAL_RELACIONAMENTO_NEXT_SUPPLY);
