package br.com.bradesco.coredigital.api.automation.test.steps.transacionalcartao.egrees.fatura.losango;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseListData;
import br.com.bradesco.coredigital.api.automation.model.response.egrees.card.losango.BillEgreesLosango;
...
public class EgreesLosangoFaturaStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<BillEgreesLosango> faturaEgreesLosangoResponse;
    ...
    private final String JSON_EGREES_SCHEMA_NAME = "card_bill_egrees_losango_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/card/";

    private final String JSON_EGREES_DATA_NAME = "card_bill_egrees_losango_data";

    private final String URL_CARTAO_FATURA_LOSANGO_EGREES = "/egress-gateway/losango/v1/credit-cards-bills-transactions";

    @Given("que seja feito uma requisição GET no endpoint de Fatura de Cartões")
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_fatura_de_cartoes() {

        Headers header = headerUtils.getHeader(
                new Header("identification", "178582x8582199"),
                new Header("brand", "LOS"));

        faturaEgreesLosangoResponse = fornecimentoService.getResponseListData(ProjectType.CARD_BILL_LOSANGO_EGREES, ROOT_JSON_DATA_PATH,
                JSON_EGREES_DATA_NAME, header, BillEgreesLosango.class, URL_CARTAO_FATURA_LOSANGO_EGREES);


        printJsonBradescoReport(faturaEgreesLosangoResponse);
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = faturaEgreesLosangoResponse.getHttpCode();
