package br.com.bradesco.coredigital.api.automation.test.steps.transacionalcartao.egrees.lista;
...
public class CartaoEgreesListaStepDefinition extends AbstractStepDefinition {
    ...
    private final String URL_CARTAO_LISTA_EGREES = "/egress-gateway/bradescard/v1/list-cards";
    ...
    public void que_seja_feito_uma_requisicao_post_no_endpoint_de_lista_de_cartoes() {
        ...
        EgreesIdentificationRequest egreesIdentificationRequest = egreesIdentificationFactory.buildEgreesIdentificationRequest(
                origensList, marca, numeroCartao, contaFaturamento, companyId, agenciaConta, canal, usuario, egreesChaveIdentificationRequest);

        Headers header = headerUtils.getHeader(
                new Header("Authorization", "test"));

        identificacaoEgreesCartaoResponse = fornecimentoService.postObject(ProjectType.CARD_LIST_EGREES, ROOT_JSON_DATA_PATH,
                JSON_EGREES_DATA_NAME, header, egreesIdentificationRequest, IdentificationEgrees.class, URL_CARTAO_LISTA_EGREES);
