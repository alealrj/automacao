package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.emprestimo.supply.parcela;
...
import br.com.bradesco.coredigital.api.automation.model.response.supply.loans.LoansScheduleInstalmentSupply;
...
public class EmprestimoParcelaSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private ResponseObject<LoansScheduleInstalmentSupply> loansScheduleInstalmentSupply;
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "schedule_instalment_loans_supply_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/loans/";

    private final String JSON_SUPPLY_DATA_NAME = "schedule_instalment_loans_supply_data";

    private final String URL_EMPRESTIMO_PARCELA_SUPPLY = "/{0}loans/v1/contracts/{0}/scheduled-instalments";
    ...
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_emprestimo_parcelamento_contrato() {
        ...
        List<String> permission = Collections.singletonList("LOANS_SCHEDULED_INSTALMENTS_READ");
        ...
        loansScheduleInstalmentSupply = fornecimentoService.getResponseObject(ProjectType.LOANS_INSTALLMENT_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, header, LoansScheduleInstalmentSupply.class,
                URL_EMPRESTIMO_PARCELA_SUPPLY, brandName, contractId);

        printJsonBradescoReport(loansScheduleInstalmentSupply);
    ...
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_status_emprestimos_parcela() {
        ...
        statusObject = fornecimentoService.getStatus(ProjectType.LOANS_INSTALLMENT_SUPPLY, header,
    ...
    public void que_seja_feito_uma_requisicao_get_sem_permissao_no_endpoint_de_emprestimo_parcelamento_contrato() {
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = loansScheduleInstalmentSupply.getHttpCode();
    ...
    public void detalhe_deve_ser(String detalhe) {
        ...
        assertEquals(detalhe.toUpperCase(), loansScheduleInstalmentSupply.getErrors().get(0).getDetail().toUpperCase());
