package br.com.bradesco.coredigital.api.automation.test.steps.conta.supply.saldo;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseObject;
import br.com.bradesco.coredigital.api.automation.model.response.supply.account.BalanceSupply;
...
public class ContaSaldoSupplyStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<BalanceSupply> saldoContaResponse;
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "balances_account_supply_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/account/";

    private final String JSON_SUPPLY_DATA_NAME = "balances_account_supply_data";

    private final String URL_CONTA_SALDO_SUPPLY = "/{0}/open-banking/accounts/v1/accounts/{1}/balances";

    @Given("que seja feito uma requisição GET no endpoint de Saldos da Conta")
    public void que_seja_feito_um_requisição_get_no_endpoint_de_saldos_da_conta() {
        ...
        saldoContaResponse = fornecimentoService.getResponseObject(ProjectType.ACCOUNT_BALANCE_SUPPLY, ROOT_JSON_DATA_PATH,
                JSON_SUPPLY_DATA_NAME, header, BalanceSupply.class, URL_CONTA_SALDO_SUPPLY, brand, resourceId);
        printJsonBradescoReport(saldoContaResponse);
