package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.emprestimo.supply.pagamento;
...
import br.com.bradesco.coredigital.api.automation.model.response.supply.loans.LoansPaymentSupply;
...
public class EmprestimoPagamentoSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private ResponseObject<LoansPaymentSupply> loansPaymentSupplyResponseObject;
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "payment_loans_supply_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/loans/";

    private final String JSON_SUPPLY_DATA_NAME = "payment_loans_supply_data";

    private final String URL_EMPRESTIMO_PAGAMENTO_SUPPLY = "/{0}/loans/v1/contracts/{0}/payments";
    ...
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_emprestimos_pagamento() {
        ...
        List<String> permission = Collections.singletonList("LOANS_PAYMENTS_READ");
        ...
        loansPaymentSupplyResponseObject = fornecimentoService.getResponseObject(ProjectType.LOANS_PAYMENT_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, header, LoansPaymentSupply.class,
                URL_EMPRESTIMO_PAGAMENTO_SUPPLY, brandName, contractId);

        printJsonBradescoReport(loansPaymentSupplyResponseObject);
    ...
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_status_emprestimos_pagamento() {
        ...
        statusObject = fornecimentoService.getStatus(ProjectType.LOANS_PAYMENT_SUPPLY, header,
    ...
    public void que_seja_feito_uma_requisicao_get_sem_permissao_no_endpoint_de_emprestimos_pagamento() {
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = loansPaymentSupplyResponseObject.getHttpCode();
    ...
    public void detalhe_deve_ser(String detalhe) {
        ...
        assertEquals(detalhe.toUpperCase(), loansPaymentSupplyResponseObject.getErrors().get(0).getDetail().toUpperCase());
