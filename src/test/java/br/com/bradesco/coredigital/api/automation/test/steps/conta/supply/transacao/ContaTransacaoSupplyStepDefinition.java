package br.com.bradesco.coredigital.api.automation.test.steps.conta.supply.transacao;


import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseListData;
import br.com.bradesco.coredigital.api.automation.model.response.supply.account.TransactionSupply;
...
public class ContaTransacaoSupplyStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<TransactionSupply> transacaoContaResponse;
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "transactions_account_supply_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/account/";

    private final String JSON_SUPPLY_DATA_NAME = "transactions_account_supply_data";

    private final String URL_CONTA_TRANSACAO_SUPPLY = "/{0}/open-banking/accounts/v1/accounts/{1}/transactions";
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_de_Transacoes_da_Conta() {
        ...
        transacaoContaResponse = fornecimentoService.getResponseListData(ProjectType.ACCOUNT_TRANSACTION_SUPPLY, ROOT_JSON_DATA_PATH,
                JSON_SUPPLY_DATA_NAME, header, TransactionSupply.class, URL_CONTA_TRANSACAO_SUPPLY, brand, resourceId);
