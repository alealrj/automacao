package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.core.relacionamento.next;
...
public class PessoaRelacionamentoNextCoreStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<PersonalCustomerRelationCore> relacionamentoPessoalNextCore;
    ...
    private final String JSON_CORE_DATA_NAME = "personal_relation_core_next_data";

    private final String URL_PESSOAL_RELACIONAMENTO_CORE_NEXT = "/next/core/registration-data/v1/personal/financial-relations";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_relacionamento_Pessoa_Natural() {
        ...
        relacionamentoPessoalNextCore = fornecimentoService.getResponseObject(
                ProjectType.REGISTRATION_DATABRADESCO_OR_NEXT_CORE, ROOT_JSON_DATA_PATH, JSON_CORE_DATA_NAME,
                getHeaders(headerMap), PersonalCustomerRelationCore.class, URL_PESSOAL_RELACIONAMENTO_CORE_NEXT);

        printJsonBradescoReport(relacionamentoPessoalNextCore);
    ...
    public void deve_retornar_status_code_para_chamada_de_relacionamento_Pessoa_Natural(int statusCode) {
        ...
        assertEquals(statusCode, relacionamentoPessoalNextCore.getHttpCode());
