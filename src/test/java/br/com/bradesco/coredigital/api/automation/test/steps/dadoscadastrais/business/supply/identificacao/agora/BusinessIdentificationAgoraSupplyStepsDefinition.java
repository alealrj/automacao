package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.business.supply.identificacao.agora;
...
public class BusinessIdentificationAgoraSupplyStepsDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<BusinessIdentificationSupply> identificacaoJuridicaAgoraSupply;
    ...
    private final String JSON_SUPPLY_DATA_NAME = "business_identification_supply_agora_data";

    private final String URL_BUSINESS_IDENTIFICACAO_SUPPLY_AGORA = "/agora/customers/v1/business/identifications";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_Identificação_Pessoa_juridica() {
        ...
        identificacaoJuridicaAgoraSupply = fornecimentoService.getResponseListData(ProjectType.REGISTRATION_DATA_AGORA_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, getHeaders(headerMap),
                BusinessIdentificationSupply.class, URL_BUSINESS_IDENTIFICACAO_SUPPLY_AGORA);

        printJsonBradescoReport(identificacaoJuridicaAgoraSupply);
    ...
    public void usuario_deve_receber_os_status_code(int statusCode) {
        ...
        assertEquals(statusCode, identificacaoJuridicaAgoraSupply.getHttpCode());
