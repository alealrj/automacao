package br.com.bradesco.coredigital.api.automation.test.steps.conta.core.transacao;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseListData;
import br.com.bradesco.coredigital.api.automation.model.response.core.account.TransactionCore;
...
public class ContaTransacaoCoreStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<TransactionCore> transacaoContaResponse;
    ...
    private final String JSON_CORE_SCHEMA_NAME = "transactions_account_core_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/account/";

    private final String JSON_CORE_DATA_NAME = "transactions_account_core_data";

    private final String URL_CONTA_TRANSACAO_CORE = "/accounts/transactions/{0}/{1}/{2}?accountType={3}";

    @Given("que seja feito uma requisição GET no endpoint de Transações da Conta")
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_transacoes_da_conta() {
        ...
        transacaoContaResponse = fornecimentoService.getResponseListData(ProjectType.ACCOUNT_TRANSACTION_CORE, ROOT_JSON_DATA_PATH,
                JSON_CORE_DATA_NAME, header, TransactionCore.class, URL_CONTA_TRANSACAO_CORE, agency, account, accountDigit, accountType);
        printJsonBradescoReport(transacaoContaResponse);
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = transacaoContaResponse.getHttpCode();
