package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.direitoscreditoriosdescontados.core.parcelas;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.model.HealthCheck;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseObject;
import br.com.bradesco.coredigital.api.automation.model.response.core.invoicefinancings.InvoiceFinancingsInstalmentCore;
...
public class DireitosCreditoriosDescontadosParcelasCoreStepDefinition extends AbstractStepDefinition {
    ...
    private final String JSON_CORE_SCHEMA_NAME = "scheduled_instalments_invoice_financings_core_schema";

    private final String JSON_HEALTH_CHECK_CORE_SCHEMA_NAME = "healthcheck_invoice_financings_schema";
    ...
    private final String JSON_CORE_DATA_NAME = "scheduled_instalments_invoice_financings_core_data";

    private final String JSON_HEALTH_CHECK_CORE_DATA_NAME = "healthcheck_invoice_financings_core_data";

    private final String URL_DCOM_PARCELAS_CORE = "/core/invoice-financings/v1/contracts/{0}/scheduled-instalments?sourceSystem={1}&requestDate={2}&requestDatePeriodBegin={3}&requestDatePeriodEnd={4}";

    private final String URL_DIREITOS_CREDITORIOS_DESCONTADOS_HEALTH_CHECK = "/actuator/health";

    private ResponseObject<InvoiceFinancingsInstalmentCore> listaDcomParcelasCoreResponse;
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_health_check_de_DCOM_parcelas() {
        ...
        healthCheckResponse = fornecimentoService.getResponseObject(
                ProjectType.INVOICE_FINANCINGS_INSTALMENT_CORE,
                ROOT_HEALTH_CHECK_JSON_DATA_PATH,
                JSON_HEALTH_CHECK_CORE_SCHEMA_NAME,
                header,
                HealthCheck.class,
                URL_DIREITOS_CREDITORIOS_DESCONTADOS_HEALTH_CHECK
        );
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_de_direitos_creditorios_descontados_dcom_parcelas() {
        ...
        String sourceSystem = "dcom";
        String requestDate = "01/06/2021";
        String requestDatePeriodBegin = "28/05/2020";
        String requestDatePeriodEnd = "28/05/2021";

        Headers header = headerUtils.getHeader(
                new Header("Authorization", token)
        );

        listaDcomParcelasCoreResponse = fornecimentoService.getResponseObject(
                ProjectType.INVOICE_FINANCINGS_INSTALMENT_CORE,
                ROOT_JSON_DATA_PATH,
                JSON_CORE_DATA_NAME,
                header,
                InvoiceFinancingsInstalmentCore.class,
                URL_DCOM_PARCELAS_CORE,
                contractId,
                sourceSystem,
                requestDate,
        ...
        printJsonBradescoReport(listaDcomParcelasCoreResponse);
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_de_direitos_creditorios_descontados_dcom_parcelas_com_token_invalido() {
    ...
    public void pegar_o_status_code_da_requisicao() {
        statusCode = listaDcomParcelasCoreResponse.getHttpCode();
    ...
    public void a_Mensagem_De_Erro_Deve_Ser(String mensagem) {
        String erro = listaDcomParcelasCoreResponse.getErrors().get(0).getDetail();
