package br.com.bradesco.coredigital.api.automation.test.steps.transacionalcartao.egrees.limite.losango;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseListData;
import br.com.bradesco.coredigital.api.automation.model.response.egrees.card.losango.LimitEgreesLosango;
...
public class EgreesLosangoLimiteStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<LimitEgreesLosango> limiteEgreesLosangoResponse;
    ...
    private final String JSON_EGREES_SCHEMA_NAME = "card_limits_egrees_losango_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/card/";

    private final String JSON_EGREES_DATA_NAME = "card_limits_egrees_losango_data";

    private final String URL_CARTAO_LIMITE_LOSANGO_EGREES = "/egress-gateway/losango/v1/credit-cards-limits";


    @Given("que seja feito uma requisição GET no endpoint de Limites de Cartões")
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_limites_de_cartoes() {

        Headers header = headerUtils.getHeader(
                new Header("identification", "178582x8582199"),
                new Header("brand", "LOS"));

        limiteEgreesLosangoResponse = fornecimentoService.getResponseListData(ProjectType.CARD_LIMITS_LOSANGO_EGREES, ROOT_JSON_DATA_PATH,
                JSON_EGREES_DATA_NAME, header, LimitEgreesLosango.class, URL_CARTAO_LIMITE_LOSANGO_EGREES);


        printJsonBradescoReport(limiteEgreesLosangoResponse);
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = limiteEgreesLosangoResponse.getHttpCode();
