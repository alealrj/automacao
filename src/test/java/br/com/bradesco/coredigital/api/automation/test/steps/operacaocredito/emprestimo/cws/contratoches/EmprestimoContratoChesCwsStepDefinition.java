package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.emprestimo.cws.contratoches;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.factory.cws.ChesContractFactory;
import br.com.bradesco.coredigital.api.automation.model.request.cws.ChesContractRequest;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseObject;
import br.com.bradesco.coredigital.api.automation.model.response.cws.ResponseChesContractCwsObject;
...
public class EmprestimoContratoChesCwsStepDefinition extends AbstractStepDefinition {
    ...
    @Autowired
    private ChesContractFactory chesContractFactory;

    private ResponseObject<ResponseChesContractCwsObject> responseChesContractCwsObject;
    ...
    private final String JSON_CWS_CHES_SCHEMA_NAME = "contract_ches_loans_cws_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/loans/";

    private final String JSON_CWS_CHES_DATA_NAME = "contract_ches_loans_cws_data";

    private final String URL_EMPRESTIMO_CONTRATO_CHES_CWS = "/rest/cws/v1/contract-operation";

    @Given("que seja feito uma requisição POST no endpoint de Empréstimos - Contrato CHES")
    public void que_seja_feito_uma_requisicao_post_no_endpoint_de_emprestimos_contrato_ches() {
        ...
        ChesContractRequest chesContractRequest = chesContractFactory.buiChesContractRequest(ccontr, dsoltcConsDados,
                dinicConsent, dfnalConsent);

        responseChesContractCwsObject = fornecimentoService.postObject(ProjectType.CWS_LOANS_FINANCINGS_CHES,
                ROOT_JSON_DATA_PATH, JSON_CWS_CHES_DATA_NAME, getHeaders(headerMap), chesContractRequest,
                ResponseChesContractCwsObject.class, URL_EMPRESTIMO_CONTRATO_CHES_CWS);

        printJsonBradescoReport(responseChesContractCwsObject);
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = responseChesContractCwsObject.getHttpCode();
