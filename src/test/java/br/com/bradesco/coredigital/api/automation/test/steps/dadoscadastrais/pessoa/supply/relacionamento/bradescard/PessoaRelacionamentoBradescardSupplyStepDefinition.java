package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.supply.relacionamento.bradescard;
...
public class PessoaRelacionamentoBradescardSupplyStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<PersonalCustomerRelationSupply> relacionamentoPessoalBradescard;
    ...
    private final String JSON_SUPPLY_DATA_NAME = "personal_relation_bradescard_supply_data";

    private final String URL_PESSOAL_RELACIONAMENTO_BRADESCARD_SUPPLY = "/bradescard/customers/v1/personal/finantial-relations";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_Relacionamento_Pessoa_Natural() {
        ...
        relacionamentoPessoalBradescard = fornecimentoService.getResponseObject(ProjectType.REGISTRATION_DATA_BRADESCARD_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, getHeaders(headerMap),
                PersonalCustomerRelationSupply.class, URL_PESSOAL_RELACIONAMENTO_BRADESCARD_SUPPLY);

        printJsonBradescoReport(relacionamentoPessoalBradescard);
    ...
    public void usuario_deve_receber_os_status_code(int statusCode)  {
        ...
        assertEquals(statusCode, relacionamentoPessoalBradescard.getHttpCode());
