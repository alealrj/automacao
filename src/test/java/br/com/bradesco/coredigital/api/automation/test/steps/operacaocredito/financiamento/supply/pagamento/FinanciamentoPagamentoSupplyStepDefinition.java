package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.financiamento.supply.pagamento;
...
import br.com.bradesco.coredigital.api.automation.model.response.supply.financing.FinancingPaymentSupply;
...
public class FinanciamentoPagamentoSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private ResponseObject<FinancingPaymentSupply> financingPaymentSuppleResponse;
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "payment_financing_supply_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/financing/";

    private final String JSON_SUPPLY_DATA_NAME = "payment_financing_supply_data";

    private final String URL_FINANCIAMENTO_PAGAMENTO_SUPPLY = "{0}/financings/v1/contracts/{1}/payments";
...
//        List<String> permission = Collections.singletonList("FINANCINGS_PAYMENTS_READ");
...
//        String permissionEncodedAuthorization = base64Utils.getPermissionEncodedAuthorization(permissionAuthorization);
        ...
        financingPaymentSuppleResponse = fornecimentoService.getResponseObject(ProjectType.FINANCINGS_PAYMENT_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, header, FinancingPaymentSupply.class,
                URL_FINANCIAMENTO_PAGAMENTO_SUPPLY, brandName, contractId);

        printJsonBradescoReport(financingPaymentSuppleResponse);
    ...
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_status_financiamento_pagamento() {
        ...
        statusObject = fornecimentoService.getStatus(ProjectType.FINANCINGS_PAYMENT_SUPPLY, header,
    ...
    public void que_seja_feito_uma_requisicao_get_sem_permissao_no_endpoint_de_financiamento_pagamento() {
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = financingPaymentSuppleResponse.getHttpCode();
    ...
    public void detalhe_deve_ser(String detalhe) {
        ...
        assertEquals(detalhe.toUpperCase(), financingPaymentSuppleResponse.getErrors().get(0).getDetail().toUpperCase());
