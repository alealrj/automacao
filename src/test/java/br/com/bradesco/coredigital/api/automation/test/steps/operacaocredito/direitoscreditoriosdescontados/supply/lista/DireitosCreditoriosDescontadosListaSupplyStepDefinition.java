package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.direitoscreditoriosdescontados.supply.lista;
...
import br.com.bradesco.coredigital.api.automation.model.response.supply.invoiceFinancings.InvoiceFinancingsListSupply;
...
public class DireitosCreditoriosDescontadosListaSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "list_invoice_financings_supply_schema";
    ...
    private final String JSON_SUPPLY_DATA_NAME = "list_invoice_financings_supply_data";

    private final String JSON_HEALTH_CHECK_SUPPLY_DATA_NAME = "healthcheck_unarranged_accounts_overdraft_supply_data";

    private final String URL_DIREITOS_CREDITORIOS_DESCONTADOS_LISTA_SUPPLY = "/invoice-financings/v1/contracts";

    private final String URL_DIREITOS_CREDITORIOS_DESCONTADOS_HEALTH_CHECK_SUPPLY = "/actuator/health";

    private ResponseListData<InvoiceFinancingsListSupply> listaDireitosCreditoriosDescontadosResponse;
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_health_check_de_DCOM_Lista() {
        ...
        healthCheckResponse = fornecimentoService.getResponseObject(
                ProjectType.INVOICE_FINANCINGS_LIST_SUPPLY,
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_de_Operacoes_Credito_DCOM_Lista() {

        Headers header = headerUtils.getHeader(
                new Header("Authorization", token)
        );

        listaDireitosCreditoriosDescontadosResponse = fornecimentoService.getResponseListData(
                ProjectType.INVOICE_FINANCINGS_LIST_SUPPLY,
                ROOT_JSON_DATA_PATH,
                JSON_SUPPLY_DATA_NAME,
                header,
                InvoiceFinancingsListSupply.class,
                URL_DIREITOS_CREDITORIOS_DESCONTADOS_LISTA_SUPPLY
        );

        printJsonBradescoReport(listaDireitosCreditoriosDescontadosResponse);
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_de_adiantamento_depositante_ADPOS_Lista_Com_Header_Invalido() {
    ...
    public void pegar_o_status_code_da_requisicao() {
        statusCode = listaDireitosCreditoriosDescontadosResponse.getHttpCode();
    ...
    public void a_mensagem_de_erro_deve_ser (String mensagem) {
        String erro = listaDireitosCreditoriosDescontadosResponse.getErrors().get(0).getDetail();
