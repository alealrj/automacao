package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.business.supply.identificacao.bradesco;
...
public class BusinessIdentificationBradescoSupplyStepsDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<BusinessIdentificationSupply> identificacaoJuridicaBradescoSupply;
    ...
    private final String JSON_SUPPLY_DATA_NAME = "business_identification_bradesco_supply_data";

    private final String URL_BUSINESS_IDENTIFICACAO_BRADESCO_SUPPLY = "/bradesco/customers/v1/business/identifications";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_Identificação_Pessoa_Juridica() {
        ...
        identificacaoJuridicaBradescoSupply = fornecimentoService.getResponseListData(ProjectType.REGISTRATION_DATA_BRADESCO_OR_NEXT_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, getHeaders(headerMap),
                BusinessIdentificationSupply.class, URL_BUSINESS_IDENTIFICACAO_BRADESCO_SUPPLY);


        printJsonBradescoReport(identificacaoJuridicaBradescoSupply);
    ...
    public void usuario_deve_receber_os_status_code(int statusCode) {
        ...
        assertEquals(statusCode, identificacaoJuridicaBradescoSupply.getHttpCode());
