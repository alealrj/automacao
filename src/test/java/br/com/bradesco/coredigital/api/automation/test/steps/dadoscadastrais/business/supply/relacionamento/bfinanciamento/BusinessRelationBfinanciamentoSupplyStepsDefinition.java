package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.business.supply.relacionamento.bfinanciamento;
...
public class BusinessRelationBfinanciamentoSupplyStepsDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<BusinessRelationSupply> relacionamentoJuridicaBfinanciamentoSupply;
    ...
    private final String JSON_SUPPLY_DATA_NAME = "business_relation_supply_bfinanciamento_data";

    private final String URL_BUSINESS_RELACIONAMENTO_SUPPLY_BFINANCIAMENTO = "/bradesco_financiamento/customers/v1/business/financial-relations";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_relacionamento_Pessoa_Juridica() {
        ...
        relacionamentoJuridicaBfinanciamentoSupply = fornecimentoService.getResponseObject(ProjectType.REGISTRATION_DATA_LOSANGO_OR_BF_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, getHeaders(headerMap),
                BusinessRelationSupply.class, URL_BUSINESS_RELACIONAMENTO_SUPPLY_BFINANCIAMENTO);

        printJsonBradescoReport(relacionamentoJuridicaBfinanciamentoSupply);
    ...
    public void deve_retornar_status_code_para_chamada_de_relacionamento_Pessoa_Juridica(int statusCode) {
        ...
        assertEquals(statusCode, relacionamentoJuridicaBfinanciamentoSupply.getHttpCode());
