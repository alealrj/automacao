package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.core.identificacao.agora;
...
public class PessoaIdentificationAgoraServiceStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<PersonalCustomerIdentificationCore> identificacaoPessoalAgoraCore;
    ...
    private final String JSON_CORE_DATA_NAME = "personal_identification_agora_core_data";

    private final String URL_PESSOAL_IDENTIFICACAO_AGORA_CORE = "/agora-egress/customers.v1.personal.identifications?cpf-cnpj={0}";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_Identificação_Pessoa_Natural() {
        ...
        identificacaoPessoalAgoraCore = fornecimentoService.getResponseListData(ProjectType.REGISTRATION_DATA_AGORA_CORE,
                ROOT_JSON_DATA_PATH, JSON_CORE_DATA_NAME, getHeaders(headerMap), PersonalCustomerIdentificationCore.class,
                URL_PESSOAL_IDENTIFICACAO_AGORA_CORE, cpfCnpj);

        printJsonBradescoReport(identificacaoPessoalAgoraCore);
    ...
    public void usuario_deve_receber_os_status_code(int statusCode) {
        ...
        assertEquals(statusCode, identificacaoPessoalAgoraCore.getHttpCode());
