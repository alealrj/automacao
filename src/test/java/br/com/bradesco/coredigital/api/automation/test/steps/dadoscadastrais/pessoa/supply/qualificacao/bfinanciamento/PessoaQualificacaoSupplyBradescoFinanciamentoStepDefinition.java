package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.supply.qualificacao.bfinanciamento;
...
public class PessoaQualificacaoSupplyBradescoFinanciamentoStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<PersonalCustomerQualificationSupply> qualificacaoPessoalBradescoFinanciamentoSupply;
    ...
    private final String JSON_SUPPLY_BRADESCOFINANCIAMENTO_DATA_NAME = "personal_qualification_supply_bradescofinanciamento_data";

    private final String URL_PESSOAL_QUALIFICACAO_SUPPLY_BRADESCOFINANCIAMENTO = "/bradesco_financiamento/customers/v1/personal/qualifications";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_qualificação_Pessoa_natural() {
        ...
        qualificacaoPessoalBradescoFinanciamentoSupply = fornecimentoService.getResponseObject(ProjectType.REGISTRATION_DATA_LOSANGO_OR_BF_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_BRADESCOFINANCIAMENTO_DATA_NAME, getHeaders(headerMap),
                PersonalCustomerQualificationSupply.class, URL_PESSOAL_QUALIFICACAO_SUPPLY_BRADESCOFINANCIAMENTO);

        printJsonBradescoReport(qualificacaoPessoalBradescoFinanciamentoSupply);
    ...
    public void usuario_deve_receber_os_status_code(int statusCode) {
        assertEquals(statusCode, qualificacaoPessoalBradescoFinanciamentoSupply.getHttpCode());
    ...
    public void o_retorno_das_requisicões_deve_estar_de_acordo_com_contrato_definido() {
        boolean validResponse = fornecimentoService.validateSchema(ROOT_JSON_DATA_PATH, JSON_SUPPLY_BRADESCOFINANCIAMENTO_DATA_NAME,
