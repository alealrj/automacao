package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.emprestimo.supply.lista;
...
import br.com.bradesco.coredigital.api.automation.model.response.supply.loans.LoansListSupply;
...
public class EmprestimoListaSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private ResponseListData<LoansListSupply> listaEmprestimoResponse;
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "list_loans_supply_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/loans/";

    private final String JSON_SUPPLY_DATA_NAME = "list_loans_supply_data";

    private final String URL_EMPRESTIMO_LISTA_SUPPLY = "/{0}/loans/v1/contracts";

    private final String URL_STATUS = "/actuator/health";

    @Given("que seja feito uma requisição GET no endpoint de Empréstimos - Lista")
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_Emprestimos_lista() {
        ...
        listaEmprestimoResponse = fornecimentoService.getResponseListData(ProjectType.LOANS_LIST_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, header, LoansListSupply.class,
                URL_EMPRESTIMO_LISTA_SUPPLY, brandName);
    ...
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_status_emprestimos_lista() {
        ...
        statusObject = fornecimentoService.getStatus(ProjectType.LOANS_LIST_SUPPLY, header,
    ...
    public void que_seja_feito_uma_requisicao_get_sem_permissao_no_endpoint_de_Emprestimos_lista() {
    ...
    public void detalhe_deve_ser(String detalhe) {
        ...
        assertEquals(detalhe.toUpperCase(), listaEmprestimoResponse.getErrors().get(0).getDetail().toUpperCase());
