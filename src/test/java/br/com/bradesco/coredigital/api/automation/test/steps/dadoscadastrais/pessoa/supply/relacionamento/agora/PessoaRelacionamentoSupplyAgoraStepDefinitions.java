package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.supply.relacionamento.agora;
...
public class PessoaRelacionamentoSupplyAgoraStepDefinitions extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<PersonalCustomerRelationSupply> relacionamentoPessoaAgora;
    ...
    private final String JSON_SUPPLY_AGORA_DATA_NAME = "personal_relation_supply_agora_data";

    private final String URL_PESSOAL_RELACIONAMENTO_SUPPLY_AGORA = "/agora/customers/v1/personal/financial-relations";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_relacionamento_Pessoa_Natural() {
        ...
        relacionamentoPessoaAgora = fornecimentoService.getResponseObject(ProjectType.REGISTRATION_DATA_AGORA_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_AGORA_DATA_NAME, getHeaders(headerMap),
                PersonalCustomerRelationSupply.class, URL_PESSOAL_RELACIONAMENTO_SUPPLY_AGORA);

        printJsonBradescoReport(relacionamentoPessoaAgora);
    ...
    public void usuario_deve_receber_os_status_code(int statusCode) {
        assertEquals(statusCode, relacionamentoPessoaAgora.getHttpCode());
