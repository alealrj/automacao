package br.com.bradesco.coredigital.api.automation.test.steps.conta.cws.lista;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseListData;
import br.com.bradesco.coredigital.api.automation.model.response.cws.AccountListCws;
...
public class ContaListaCwsStepDefinition extends AbstractStepDefinition {
    ...
    private ResponseListData<AccountListCws> listCwsContaResponse;
    ...
    private final String JSON_CWS_SCHEMA_NAME = "list_account_cws_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/account/";

    private final String JSON_CORE_DATA_NAME = "list_account_cws_schema_data";

    private final String URL_CONTA_LISTA_CWS = "/accounts/pre-consent/list/{0}/{1}/{2}/{3}";

    @Given("que seja feito uma requisição GET no endpoint do CWS de Lista da Conta")
    public void que_seja_feito_uma_requisicao_get_no_endpoint_do_cws_de_lista_da_conta() {
        ...
        listCwsContaResponse = fornecimentoService.getResponseListData(ProjectType.ACCOUNT_LIST_CWS, ROOT_JSON_DATA_PATH,
                JSON_CORE_DATA_NAME, getHeaders(headerMap), AccountListCws.class, URL_CONTA_LISTA_CWS, Agency, Account, Checkdigit, Holder);
        printJsonBradescoReport(listCwsContaResponse);
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = listCwsContaResponse.getHttpCode();
