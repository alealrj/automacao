package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.financiamento.supply.garantia;
...
import br.com.bradesco.coredigital.api.automation.model.response.supply.financing.FinancingWarrantySupply;
...
public class FinanciamentoGarantiaSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private ResponseListData<FinancingWarrantySupply> financingWarrantySupply;
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "warranty_financing_supply_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/financing/";

    private final String JSON_SUPPLY_DATA_NAME = "warranty_financing_supply_data";

    private final String URL_FINANCIAMENTO_GARANTIA_SUPPLY = "/financings/v1/contracts/{0}/warranties";
    ...
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_financiamento_garantia_contrato() {
        ...
        List<String> permission = Collections.singletonList("FINANCINGS_WARRANTIES_READ");
        ...
        financingWarrantySupply = fornecimentoService.getResponseListData(ProjectType.FINANCINGS_WARRANTY_SUPPLY,
                ROOT_JSON_DATA_PATH, JSON_SUPPLY_DATA_NAME, header, FinancingWarrantySupply.class,
                URL_FINANCIAMENTO_GARANTIA_SUPPLY, contractId);

        printJsonBradescoReport(financingWarrantySupply);
    ...
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_status_financiamento_garantia_contrato() {
        ...
        statusObject = fornecimentoService.getStatus(ProjectType.FINANCINGS_WARRANTY_SUPPLY, header,
    ...
    public void que_seja_feito_uma_requisicao_get_sem_permissao_no_endpoint_de_financiamento_garantia_contrato() {
    ...
    public void pegar_o_status_code_da_requisicao() {
        ...
        statusCode = financingWarrantySupply.getHttpCode();
    ...
    public void detalhe_deve_ser(String detalhe) {
        ...
        assertEquals(detalhe.toUpperCase(), financingWarrantySupply.getErrors().get(0).getDetail().toUpperCase());
