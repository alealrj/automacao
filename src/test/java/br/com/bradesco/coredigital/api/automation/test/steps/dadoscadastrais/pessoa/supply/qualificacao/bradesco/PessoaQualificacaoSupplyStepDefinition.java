package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.supply.qualificacao.bradesco;
...
public class PessoaQualificacaoSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private final String JSON_SUPPLY_DATA_NAME = "personal_qualification_bradesco_supply_data";

    private final String URL_PESSOAL_QUALIFICACAO_SUPPLY = "/bradesco/customers/v1/personal/qualifications";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_Qualificação_Pessoa_Natural()  {
        ...
        qualificacaoPessoal = fornecimentoService.getResponseObject(ProjectType.REGISTRATION_DATA_BRADESCO_OR_NEXT_SUPPLY,
                ...
                PersonalCustomerQualificationSupply.class, URL_PESSOAL_QUALIFICACAO_SUPPLY);
