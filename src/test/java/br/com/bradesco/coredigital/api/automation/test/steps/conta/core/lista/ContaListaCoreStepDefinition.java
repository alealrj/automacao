package br.com.bradesco.coredigital.api.automation.test.steps.conta.core.lista;

import br.com.bradesco.coredigital.api.automation.enums.ProjectType;
import br.com.bradesco.coredigital.api.automation.model.response.ResponseListData;
import br.com.bradesco.coredigital.api.automation.model.response.core.account.ListCore;
...
public class ContaListaCoreStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseListData<ListCore> listaContaResponse;
    ...
    private final String JSON_CORE_SCHEMA_NAME = "list_account_core_schema";

    private final String ROOT_JSON_DATA_PATH = "src/main/resources/json_data/account/";

    private final String JSON_CORE_DATA_NAME = "list_account_core_data";

    private final String URL_CONTA_LISTA_CORE = "/accounts/{0}/{1}/{2}/{3}";

    @Given("que seja feito uma requisição GET no endpoint de Lista de Contas")
    public void que_seja_feito_uma_requisicao_get_no_endpoint_de_lista_de_contas() {
        ...
        listaContaResponse = fornecimentoService.getResponseListData(ProjectType.ACCOUNT_LIST_CORE, ROOT_JSON_DATA_PATH,
                JSON_CORE_DATA_NAME, header, ListCore.class, URL_CONTA_LISTA_CORE, agency, account, accountDigit, reason);
