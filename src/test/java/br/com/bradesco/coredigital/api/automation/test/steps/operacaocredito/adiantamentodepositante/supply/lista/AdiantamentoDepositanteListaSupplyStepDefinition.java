package br.com.bradesco.coredigital.api.automation.test.steps.operacaocredito.adiantamentodepositante.supply.lista;
...
import br.com.bradesco.coredigital.api.automation.model.response.supply.unarrangedaccountsoverdraft.UnarrangedAccountsOverdraftListSupply;
...
public class AdiantamentoDepositanteListaSupplyStepDefinition extends AbstractStepDefinition {
    ...
    private final String JSON_SUPPLY_SCHEMA_NAME = "list_unarranged_accounts_overdraft_supply_schema";
    ...
    private final String JSON_SUPPLY_DATA_NAME = "list_unarranged_accounts_overdraft_supply_data";

    private final String JSON_HEALTH_CHECK_SUPPLY_DATA_NAME = "healthcheck_unarranged_accounts_overdraft_supply_data";

    private final String URL_ADIANTAMENTO_DEPOSITANTE_LISTA_SUPPLY = "/unarranged-accounts-overdraft/v1/contracts";

    private final String URL_ADIANTAMENTO_DEPOSITANTE_HEALTH_CHECK_SUPPLY = "/actuator/health";

    private ResponseListData<UnarrangedAccountsOverdraftListSupply> listaAdiantamentoDepositanteResponse;
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_health_check_de_adiantamento_a_depositante_ADPOS_Lista() {
        ...
        healthCheckResponse = fornecimentoService.getResponseObject(
                ProjectType.UNARRANGED_ACCOUNTS_OVERDRAFT_LIST_SUPPLY,
    ...
    public void que_seja_feito_uma_requisicao_GET_no_endpoint_de_Adiantamento_a_Depositante_ADPOS_Lista() {
        ...
        listaAdiantamentoDepositanteResponse = fornecimentoService.getResponseListData(
                ...
                header,
                UnarrangedAccountsOverdraftListSupply.class,
                URL_ADIANTAMENTO_DEPOSITANTE_LISTA_SUPPLY
        );
