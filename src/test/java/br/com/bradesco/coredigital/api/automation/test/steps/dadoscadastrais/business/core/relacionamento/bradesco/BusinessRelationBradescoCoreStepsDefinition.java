package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.business.core.relacionamento.bradesco;
...
public class BusinessRelationBradescoCoreStepsDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<BusinessRelationCore> relacionamentoBusinessBradescoCore;
    ...
    private final String JSON_CORE_DATA_NAME = "business_relation_core_bradesco_data";

    private final String URL_BUSINESS_RELACIONAMENTO_CORE_BRADESCO = "/bradesco/core/registration-data/v1/business/financial-relations";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_relacionamento_Pessoa_Juridica() {
        ...
        relacionamentoBusinessBradescoCore = fornecimentoService.getResponseObject(
                ProjectType.REGISTRATION_DATABRADESCO_OR_NEXT_CORE, ROOT_JSON_DATA_PATH, JSON_CORE_DATA_NAME,
                getHeaders(headerMap), BusinessRelationCore.class, URL_BUSINESS_RELACIONAMENTO_CORE_BRADESCO);

        printJsonBradescoReport(relacionamentoBusinessBradescoCore);
    ...
    public void deve_retornar_status_code_para_chamada_de_relacionamento_Pessoa_Juridica(int statusCode) {
        ...
        assertEquals(statusCode, relacionamentoBusinessBradescoCore.getHttpCode());
