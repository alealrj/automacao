package br.com.bradesco.coredigital.api.automation.test.steps.dadoscadastrais.pessoa.core.qualificacao.next;
...
public class PessoaQualificacaoNextCoreStepDefinition extends AbstractStepDefinition {

    @Autowired
    private FornecimentoService fornecimentoService;

    private ResponseObject<PersonalCustomerQualificationCore> qualificacaoPessoalNextCore;
    ...
    private final String JSON_CORE_DATA_NAME = "personal_qualification_next_core_data";

    private final String URL_PESSOAL_QUALIFICACAO_NEXT_CORE = "/next/core/registration-data/v1/personal/qualifications";
    ...
    public void seja_realizada_uma_requisição_GET_no_endpoint_de_qualificacao_Pessoa_Natural() {
        ...
        qualificacaoPessoalNextCore = fornecimentoService.getResponseObject(
                ProjectType.REGISTRATION_DATABRADESCO_OR_NEXT_CORE, ROOT_JSON_DATA_PATH, JSON_CORE_DATA_NAME,
                getHeaders(headerMap), PersonalCustomerQualificationCore.class, URL_PESSOAL_QUALIFICACAO_NEXT_CORE);

        printJsonBradescoReport(qualificacaoPessoalNextCore);
    ...
    public void deve_retornar_status_code_para_chamada_de_qualificacao_Pessoa_Natural(int statusCode) {
        ...
        assertEquals(statusCode, qualificacaoPessoalNextCore.getHttpCode());
